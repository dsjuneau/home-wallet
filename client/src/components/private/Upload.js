        ...
        .then(response => {
          if (200 === response.status) {
            ...
            if (response.data.error) {
              ...
              this.ocShowAlert("Document Uploaded Successfully", "green");
            }
          }
        })
        .catch(error => {
          ...
          if (200 === response.status) {
            ...
            if (response.data.error) {
              if ("LIMIT_FILE_SIZE" === response.data.error.code) {
                ...
                this.ocShowAlert("Max 4 documents allowed", "red");
              } else {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>
          <img
            src="https://homewalletuploads.s3.us-east-2.amazonaws.com/coding-1565983019052.jpg"
            alt="most-recent"
          />
        </div>
      </div>
